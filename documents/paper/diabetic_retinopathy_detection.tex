...
\begin{itemize}
  \item[-] \textbf{Graham preprocessing:  [report kaggle]} \begin{itemize}
    ...
    \begin{figure}[h]
      \centering
      \subfloat[Original image]{\includegraphics[width=0.2\textwidth]{IDRiD_060.jpg}\label{fig:IDRiD_backprop_orig}}
      \hspace{0.5cm}
      \subfloat[Processed image]{\includegraphics[width=0.2\textwidth]{IDRiD_060_graham.jpg}\label{fig:IDRiD_backprop_enh}}
...
\begin{figure}[h]
  \centering
  \subfloat[Original result]{\includegraphics[width=0.2\textwidth]{IDRiD_060_backprop_orig.png}\label{fig:IDRiD_backprop_orig}}
  \hspace{0.5cm}
  \subfloat[Enhanced result]{\includegraphics[width=0.2\textwidth]{IDRiD_060_backprop_enh.png}\label{fig:IDRiD_backprop_enh}}
